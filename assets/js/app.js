 ...
 */
var SERVER_NAME = 'Monman11';
var SERVER_IP = 'monman11.com';
document.querySelector(".release").style.display = "none";
getServerStatus = (async () => {
    return await fetch(`https://api.mcsrvstat.us/2/${SERVER_IP}`).then(e => e.json()).catch(e => console.error(e))
    ...
    const e = document.getElementById("helpModal"),
        t = document.getElementById("helpModalButton"),
        n = document.getElementById("closeHelpModal"),
        s = document.getElementById("closeHelpModal2");
...
// Event listener to handle slide animation on scroll
